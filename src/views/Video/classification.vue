...
<script>
import { allSort,deleteVideoSortById,insertVideoSort,updateVideoSort } from '../../service/index'
import addClassMessage from '../VideoMessageBox/addClassMessage'
export default {
    name:'publishArticle',
    data() {
        return {
    ...
    methods: {
        ...
        handleDelete(index, row) {
            ...
            confirmButtonClass: 'DetermineMessage',
                ...
                deleteVideoSortById(data).then(res => {
                    if(res.data.code == 200){
                        this.$message({
                            type: 'success',
